...
Note Visitor SDK is deprecated way of extending Chat Widget. Please use [Customer SDK](https://developers.livechatinc.com/docs/extending-ui/extending-chat-widget/customer-sdk/) instead – it is a newer library with much more features.
