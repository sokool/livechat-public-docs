...
This document describes the **Customer Chat Web API v3.2**. This is the **developer preview** version recommended only for the **experimental** use. [Read more about versionig...](/messaging/#api-versioning)
