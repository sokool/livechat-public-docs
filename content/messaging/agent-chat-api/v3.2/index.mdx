...
This document describes the **Agent Chat Web API v3.2**. This is the **developer preview** version recommended only for the **experimental** use. [Read more about versionig...](/messaging/#api-versioning)
...
<Scopes
  title="Agents scopes"
  scopes="agents--my:rw,agents--all:rw,access_rules:ro"
/>
